...
if __name__ == '__main__':
    ...
    # Get the logger
    deep_net_utils.set_logger(os.path.join(args.model_dir, 'evaluate.log'))
    ...
    deep_net_utils.load_checkpoint(os.path.join(
    ...
    deep_net_utils.save_dict_to_json(test_metrics, save_path)